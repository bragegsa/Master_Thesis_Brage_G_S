function y = RGAE_split(data_graph,data_ae,lambda,S,n_hid, map, epochs, lr, dataset_name, network_setup)
% Methodology.
% INPUTS:
...
%   - y:     final detection map (rows by columns).
    ...
    [SG,X_new,idex,X_data]=SuperGraph_split(data_graph,data_ae,S, map, dataset_name);
