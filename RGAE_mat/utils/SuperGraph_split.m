function [SG,X_new,idex,X_data]=SuperGraph_split(data_graph,data_ae,S, mask, dataset_name)
...
%   - idex:  the indices of the rows of 'X_new' corresponding to the reshaped 'data'.
    ...
    [M,N,L]=size(data_graph);
    X=reshape(data_ae,M*N,L);
    X_graph=reshape(data_graph,M*N,L);
