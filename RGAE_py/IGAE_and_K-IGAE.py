import torch
from utils import ROC, RGAE_int, train_RGAE_int, plot_loss, plot_det_map, calculate_det_map_int, plot_auc_and_epochloss
import os
...
for i, dataset_name in enumerate(dataset_list):
    ...
    hidden_dim = 100
    model = RGAE_int(dataset_name, at, hidden_dim, dataset_folder='default', dataset_var="abu")

    model.alpha = 0.1

    model.learning_rate = lr_list[i]
    model.lambda_g = lambda_list[i] #/100
    model.epochs = 500
    model.batch_num = 100
